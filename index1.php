...
<html lang="en">
	...
	<body class="container">
		...
		<main class="container row">
            ...
            <section id='instructions' class="col-lg-6 px-md-5">                    
                <p class="px-sm-5 px-md-3 my-lg-5 text-lg-left">Happy Trails, offers the service where you can look up an outdoor park and know what the weather is like today and tomorrow. So you can plan your next hike.</p>
                <h3>Pick your next Park</h3>
			...
			<div id='map' class="mb-4 col-lg-6"></div>
		</main>
